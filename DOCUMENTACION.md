...
>El cliente realiza una solicitud HTTP -> Express la recibe y procesa -> el backend ejecuta la lógica necesaria ->
 ...
 ![diagrama-flujo-servidor-a-cliente](/docs/M6/L1/diagrama-flujo-servidor-cliente.png)
---
...
![captura-código-index-lección2](/docs/M6/L2/captura-codigo-index-L2.png)

Todo esto fue validado ejecutando el archivo.

![captura-resultado-ejecución-index-leccion2](/docs/M6/L2/captura-resultado-ejecucion-index-L2.png)
...
#### Evidencias
- Ruta principal `/`
![captura-ruta-principal](/docs/M6/L4/captura-ruta-principal-L4.png)

- Ruta `/status`
![captura-ruta-status](/docs/M6/L4/captura-ruta-status-L4.png)

- Contenido estático `/index.html`
![captura-ruta-contenido-estatico](/docs/M6/L4/captura-ruta-contenido-estatico-L4.png)
...
![captura-resultado-logs](/docs/M6/L5/captura-log-L5.png)
...
![captura-enlace-sql-L1-M7.png](/docs/M7/L1/captura-enlace-sql-L1-M7.png)
...
![captura-insercion-datos-sql](/docs/M7/L2/captura-insercion-datos-sql-L2-M7.png)

- Registro de la ruta GET`/usuarios`

![captura-ruta-usuarios](/docs/M7/L2/captura-ruta-usuarios-L2-M7.png)
...
![captura-put-usuario](/docs/M7/L3/captura-put-usuario-L3-M7.png)

- Eliminación exitosa mediante `DELETE /usuarios/:id`

![captura-delete-usuario](/docs/M7/L3/captura-delete-usuario-L3-M7.png)

- Validación de ID inexistente en las operaciones `PUT` y `DELETE`

![captura-validacion-id](/docs/M7/L3/captura-validacion-id-L3-M7.png)
...
![captura-transaccion-exitosa](/docs/M7/L4/captura-transaccion-exitosa-L4-M7.png)

- Error forzado y comprobación del `ROLLBACK`

![captura-rollback-1](/docs/M7/L4/captura-rollback-L4-M7-1.png)

![captura-rollback-2](/docs/M7/L4/captura-rollback-L4-M7-2.png)
...
![captura-comparacion-orm](/docs/M7/L5/captura-comparacion-orm-L5-M7.png)
...
![captura-relacion-orm](/docs/M7/L6/captura-relacion-orm-L6-M7.png)
...
![captura-api-rest](/docs/M8/L1/captura-api-rest-L1-M8.png)
...
![captura-tests-exito](/docs/M8/L2/captura-tests-exito-L2-M8.png)

- Validaciones y respuestas de error

![captura-tests-error](/docs/M8/L2/captura-tests-error-L2-M8.png)
...
En esta lección se incorporó la funcionalidad de subida de archivos al backend utilizando `Multer`.

El objeetivo fue permitir que la aplicación reciba archivos mediante una solicitud `multipart/form-data`, controle el tipo de archivo y lo almacene en una carpeta pública del proyecto.

#### Configuración de Multer

Se instaló la dependencia `Multer` mediante **npm** y se creó el archivo:
...
Este middleware configura el almacenamiento de los archivos en:

`public/uploads/`

Además, se estableció un filtro para permitir únicamente archivos de imagen con las extensiones:
...
Los archivos reciben un nombre generado a partir de la fecha de subida y su nombre original para evitar conflictos entre archivos con el mismo nombre.
...
La ruta recibe un único archivo mediante el campo `archivo` utilizando `multipart/form-data`.

Cuando la subida se realiza correctamente, la API  responde con código HTTP `201` e informa el nombre y la ruta pública del archivo.

Si no se recibe ningún archivo, la API responde con código HTTP `400`.
...
La carpeta `public` ya se encuentra configurada como contenido estático de Express, por lo que los archivos pueden ser accedidos mediante una ruta como:

`/uploads/nombre-del-archivo.png`

#### Pruebas realizadas

Se realizó una prueba utilizando una imagen PNG real.

Se comprobó:

- Subida correcta mediante `POST /upload`.
- Generación del nombre del archivo.
- Existencia física del archivo dentro de `public/uploads/`.
- Acceso al archivo mediante Express.
- Respuesta HTTP `200 OK`
- Identificación del archivo como `image/png`.

#### Evidencia

![captura-upload](/docs/M8/L3/captura-upload-L3-M8.png)
